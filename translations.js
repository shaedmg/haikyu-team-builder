...
const translations = {
  en: {
    ...
    // Meta tags
    metaDescription:
      '🏐 Build your perfect Haikyu Flight High volleyball team! Create teams with Karasuno, Nekoma, Shiratorizawa characters. Interactive team builder with bonds, statistics and school synergies. Free Haikyu team planner tool.',
    metaKeywords:
  ...
  es: {
    ...
    subtitle:
      'Crea Equipos de Voleibol Perfectos con Vínculos de Personajes y Sinergias Escolares',
    ...
    // Meta tags
    metaDescription:
      '🏐 ¡Construye tu equipo perfecto de Haikyu Flight High! Crea equipos con personajes de Karasuno, Nekoma, Shiratorizawa. Constructor de equipos interactivo con vínculos, estadísticas y sinergias escolares. Herramienta gratuita de planificación de equipos Haikyu.',
    metaKeywords:
